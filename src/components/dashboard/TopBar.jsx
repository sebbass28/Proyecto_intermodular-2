    ...
    return (
        <>
            ...
            <div className="bg-white/10 backdrop-blur-lg border-b border-white/20 px-6 py-4 shadow-lg flex items-center justify-between">
                ...
                >
                    {/* Logo FinanceFlow */}
                    <img src="public/finance-flow-logo-gradient.svg" alt="" className="w-10 h-10"/>
                ...
                <div className="flex items-center gap-4 w-64 justify-end">
                    {/* Ajustes */}
                    <Link>
                    <button className="p-2 text-gray-400 hover:text-emerald-600 hover:bg-gray-100 rounded-full transition-colors">
