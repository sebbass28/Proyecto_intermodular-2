...
const TopBar = ({
  ...
  return (
    <div className="bg-white/10 dark:bg-gray-800/50 backdrop-blur-lg border-b border-white/20 dark:border-gray-700 px-6 py-4 shadow-lg flex items-center justify-between transition-colors duration-300">
      {/* LADO IZQUIERDO: LOGO */}
      {/* LADO IZQUIERDO: LOGO */}
      <a
        href="/dashboard"
      ...
      <div className="flex-1 flex justify-center px-4">
        <div className="relative">
          ...
          <input
            ...
            className="w-96 min-w-96 max-w-96 pl-10 pr-4 py-2 bg-white/10 dark:bg-gray-700/50 backdrop-blur-md border border-white/20 dark:border-gray-600 rounded-full text-sm text-gray-700 dark:text-gray-200 placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:bg-white/20 dark:focus:bg-gray-600/50 focus:border-white/40 shadow-inner transition-all"
      ...
      <div className="flex items-center gap-4 w-64 justify-end">
        ...
        <button
          onClick={toggleTheme}
          className="p-2 text-gray-400 dark:text-gray-300 hover:text-yellow-500 dark:hover:text-yellow-400 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-all"
          title={
        ...
        >
          ...
          <div className="hidden md:block text-left">
            <p className="text-sm font-semibold text-gray-700 dark:text-gray-200 leading-none mb-0.5">
              {user?.name || "Usuario"}
            </p>
