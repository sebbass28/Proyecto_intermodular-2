  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-gray-900 font-inter text-gray-900 dark:text-gray-100 transition-colors duration-300">
      ...
      <div className="flex flex-1 overflow-hidden h-screen pt-0">
        ...
        {/* Contenido Principal */}
        <div className="flex-1 flex flex-col overflow-y-auto h-full scroll-smooth bg-gray-50/50 dark:bg-gray-900 transition-colors duration-300">
          <header className="flex items-center justify-between lg:hidden h-16 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 p-4 shrink-0 sticky top-0 z-40 shadow-sm transition-colors duration-300">
